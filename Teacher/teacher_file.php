...
<head>
    ...
    <title>Tài liệu - Giáo viên</title>
...
<body>
    ...
    <div class="noidung">
        ...
        <div class="edit_content">
            <button onclick="location.href = 'teacher_upload_add.php';">Thêm tài liệu</button>
        </div>
        ...
        <div class="lesson_show">
            <!-- <div class="lesson_box">
                ...
                <div class="lesson_box_btn">
                    <button onclick="location.href = 'teacher_file_detail.php';">Xem chi tiết</button>
                </div>
            </div>
            ...
            <div class="lesson_box">
                ...
                <div class="lesson_box_btn">
                    <button style="background-color: red;" onclick="location.href = 'connect.php?delete=<?php echo $row['MaTL'];?>';">Xóa</button>
                    <button onclick="location.href = 'teacher_upload_edit.php?MaTL=<?php echo $row['MaTL'] ?>';">Chỉnh sửa</button>
                    <button onclick="location.href = 'teacher_file_detail.php?MaTL=<?php echo $row['MaTL'] ?>';">Xem chi tiết</button>
